...
test('Dot products', () => {
  ...
  const dotProducts = [{
    gradient: new Vector(0.101279205538, 0.994858041394),
    vector: new Vector(0.3, 0.1),
    expected: 0.1298695658008
  }, {
    gradient: new Vector(0.007886915561, -0.999968897798),
    vector: new Vector(-0.7, 0.1),
    expected: -0.1055177306725
  }, {
    gradient: new Vector(0.937233865382, -0.348701421821),
    vector: new Vector(-0.3, -0.9),
    expected: 0.0326611200243
  }, {
    gradient: new Vector(-0.037835073065, 0.999283997293),
    vector: new Vector(-0.7, -0.9),
    expected: -0.8728710464182
  }, {
    gradient: new Vector(-0.992802137105, 0.119766091022),
    vector: new Vector(0, 0),
    expected: 0
  }, {
    gradient: new Vector(0.263549535693, -0.964645863639),
    vector: new Vector(-1, -1),
    expected: 0.701096327946
  }, {
    gradient: new Vector(1, 0),
